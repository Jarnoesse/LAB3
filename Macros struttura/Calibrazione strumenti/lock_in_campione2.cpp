...
double right_limit[]={695,725,753, 782,810,838, 867,895,923, 952,982,1000, 1040,1068,1097, 1130,1159,1187, 1215,1246,1276, 1968,2017,1140};
  ...
  cMono->Print("Monocromatore_lambda_VS_tacche.png");
	...
	read10("dati_lock_in_campione_2.txt",measureN,tacche,V0fd,V0fderr,Vfd,Vfderr,Vfc0,Vfc0err,Vfc90,Vfc90err,PointsNumber);
  ...
  gTrasmittanza->SetTitle("Trasmittanza su oscilloscopio VS #lambda (campione 2, lock-in)");
  ...
  cTrasmittanza->Print("Lock_in_Trasmittanza_VS_lambda_campione2.png");
...
TCanvas* cFotocorrente = new TCanvas("Fotocorrente su oscilloscopio VS #lambda", "Fotocorrente su oscilloscopio VS #lambda", 600,400);
  ...
  cFotocorrente->Print("Lock_in_Fotocorrente_VS_lambda_campione2.png");
